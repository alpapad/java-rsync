 ...
 */
package com.github.java.rsync.filter;
...
public class FilterRuleConfigurationTest {
    ...
    public void test4a() throws ArgumentParsingError {
        ...
        FilterRuleConfiguration parentCfg = new FilterRuleConfiguration(null, rootDirectory);
        ...
        assertEquals(true, dirCfg.include("test", false) && !dirCfg.include(mergeFile, false) && dirCfg.include("abc", false) && !dirCfg.include("def", false));
    }
    ...
    public void test5() throws ArgumentParsingError {
        ...
        assertEquals(true, parentCfg.include("test", false) && dirCfg.include(mergeFile, false) && parentCfg.include("abc", false) && parentCfg.include("def", false) && dirCfg.include("test", false)
                && dirCfg.include("abc", false) && !dirCfg.include("def", false));
    }
    ...
    public void test5a() throws ArgumentParsingError {
        ...
        FilterRuleConfiguration subCfg = new FilterRuleConfiguration(parentCfg, rootDirectory);
        subCfg.readRule("+ test");
        
        assertEquals(true, parentCfg.include("test", false) && parentCfg.include(mergeFile, false) && parentCfg.include("abc", false) && parentCfg.include("def", false)
    ...
    public void test6() throws ArgumentParsingError {
        ...
        assertEquals(true, parentCfg.include("test", false) && dirCfg.include(mergeFile, false) && dirCfg.include("abc", false) && !parentCfg.include("def", false) && dirCfg.include("test", false)
                && dirCfg.include("ghi", false) && !dirCfg.include("def", false));
    }
    ...
    public void testHiding() throws ArgumentParsingError {
        ...
        assertEquals(true, parentCfg.include("test", false) && dirCfg.include(mergeFile, false) && !parentCfg.include("def", false) && parentCfg.include("test", false) && dirCfg.include("abc", false)
    ...
    public void testProtection() throws ArgumentParsingError {
        ...
        assertEquals(true, parentCfg.include("test", false) && dirCfg.include(mergeFile, false) && dirCfg.include("abc", false) && !parentCfg.include("def", false) && dirCfg.include("test", false)
                && dirCfg.include("ghi", false) && !dirCfg.include("def", false) && dirCfg.protect("test", false) && dirCfg.risk("test2", false));
    }
}
