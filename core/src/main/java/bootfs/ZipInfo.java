...
import static bootfs.ZipConstants.CENATT;
import static bootfs.ZipConstants.CENATX;
import static bootfs.ZipConstants.CENCOM;
import static bootfs.ZipConstants.CENCRC;
import static bootfs.ZipConstants.CENDSK;
...
import static bootfs.ZipConstants.CENVEM;
...
import static bootfs.ZipConstants.LOCCRC;
import static bootfs.ZipConstants.LOCEXT;
import static bootfs.ZipConstants.LOCFLG;
import static bootfs.ZipConstants.LOCHDR;
import static bootfs.ZipConstants.LOCHOW;
import static bootfs.ZipConstants.LOCLEN;
import static bootfs.ZipConstants.LOCNAM;
import static bootfs.ZipConstants.LOCSIG;
import static bootfs.ZipConstants.LOCSIZ;
import static bootfs.ZipConstants.LOCTIM;
import static bootfs.ZipConstants.LOCVER;
...
public class ZipInfo {
    ...
    public static void main(String[] args) throws Throwable {
        if (args.length < 1) {
            ...
            SpringBootFileSystem zfs = new SpringBootFileSystemProvider().newFileSystem(Paths.get(args[0]), env);
            byte[] cen = zfs.cen;
            if (cen == null) {
            ...
            while (pos + CENHDR < cen.length) {
                ...
                if (zfs.readFullyAt(buf, 0, len, locoff(cen, pos)) != len) {
                    SpringBootFileSystem.zerror("read loc header failed");
                }
