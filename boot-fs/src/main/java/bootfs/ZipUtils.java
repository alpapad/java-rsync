...
class ZipUtils {
    ...
    public static long dosToJavaTime(long dtime) {
        LocalDateTime ldt = LocalDateTime.of((int) ((dtime >> 25 & 0x7f) + 1980), (int) (dtime >> 21 & 0x0f), (int) (dtime >> 16 & 0x1f), (int) (dtime >> 11 & 0x1f), (int) (dtime >> 5 & 0x3f),
                (int) (dtime << 1 & 0x3e));
    ...
    public static long javaToDosTime(long time) {
        ...
        return (year << 25 | ldt.getMonthValue() << 21 | ldt.getDayOfMonth() << 16 | ldt.getHour() << 11 | ldt.getMinute() << 5 | ldt.getSecond() >> 1) & 0xffffffffL;
    }
