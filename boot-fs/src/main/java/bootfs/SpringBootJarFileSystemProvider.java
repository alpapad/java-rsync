...
public class SpringBootJarFileSystemProvider extends SpringBootFileSystemProvider {
    ...
    public Path getPath(URI uri) {
        ...
        throw new IllegalArgumentException("URI: " + uri + " does not contain path fragment ex. bootJar:///c:/foo.jar!/BAR");
    }
