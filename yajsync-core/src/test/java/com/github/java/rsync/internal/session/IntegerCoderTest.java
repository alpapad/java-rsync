...
import com.github.java.rsync.test.ReadableByteBuffer;
...
public class IntegerCoderTest {
    ...
    public static Collection<Object[]> testsCollection() {
        ...
        return Arrays.asList(new Object[][] { { val_1, res_1 }, { val_2, res_2 }, { val_3, res_3 }, { val_4, res_4 }, { val_5, res_5 }, { val_6, res_6 }, { val_7, res_7 }, { val_8, res_8 },
                { val_9, res_9 }, { val_10, res_10 }, { val_11, res_11 }, { val_12, res_12 }, { val_13, res_13 }, { val_14, res_14 }, { val_15, res_15 }, { val_16, res_16 }, { val_17, res_17 },
                { val_18, res_18 }, { val_19, res_19 } });
    }
    ...
    public IntegerCoderTest(long input, byte[] expected) {
        this._input = input;
        this._expected = ByteBuffer.wrap(expected);
    }
    
    @Test
    public void testEncodingCorrectness() {
        ByteBuffer actual = IntegerCoder.encodeLong(this._input, _minBytes);
        assertEquals(String.format("encode %d -> %s, expected %s (minBytes=%d)", this._input, Text.byteBufferToString(actual), Text.byteBufferToString(this._expected), _minBytes), this._expected,
                actual);
    }
    
    @Test
    public void testEncodingDecodingSymmetry() throws Exception {
        ByteBuffer encodedBytes = IntegerCoder.encodeLong(this._input, _minBytes);
        ReadableByteBuffer rbb = new ReadableByteBuffer(encodedBytes);
        long decoded = IntegerCoder.decodeLong(rbb, _minBytes);
        assertEquals(this._input, decoded);
    }
}
